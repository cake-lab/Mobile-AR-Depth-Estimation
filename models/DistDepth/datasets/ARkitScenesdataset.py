...
from .ARkitScenesbase import ARkitScenesBase

class ARkitScenesDataset(ARkitScenesBase):
    def __init__(self, *args, **kwargs):
        super(ARkitScenesDataset, self).__init__(*args, **kwargs)
    ...
    def get_depth(self, path, do_flip):
        ...
        depth_gt = np.array(depth_gt, dtype=np.float32) / 1000.0  # convert to meters
